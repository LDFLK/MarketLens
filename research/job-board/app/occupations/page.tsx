                ...
                <div key={level} className="flex items-end gap-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="bg-zinc-100 rounded-xl px-3 py-2.5 text-xs font-bold text-zinc-700 outline-none border border-transparent focus:border-zinc-300 max-w-[210px] truncate"
                    >
                      {options.map((opt) => (
        ...
        <div className="bg-white border border-zinc-200 rounded-xl shadow-sm">
          ...
          <div className="px-5 border-b border-zinc-200 flex gap-6">
            <button
              ...
              className={`py-3 text-xs font-bold border-b-2 -mb-px transition-colors ${
                activeTab === "analytics"
